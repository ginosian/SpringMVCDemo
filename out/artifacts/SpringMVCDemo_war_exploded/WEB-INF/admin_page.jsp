  ...
  <table align="center" cellpadding="1" cellspacing="1" id="admin_home" style="width: 100%; height: 100%">
        ...
        <ul id="project_list_admin" >
          <c:forEach items="${tasks}" var="tasks">
            <li style="text-align: left" id="${tasks.getStory()}">
              <span style="font-size:24px;">${tasks.getStory()}</span>
            </li>
          </c:forEach>
        </ul>
        <%--<ul id="task_list_admin">--%>
    ...
    <tr>
      ...
      <td style="text-align: center; vertical-align: middle;">
        <input name="create_task" onclick="location.href='${root}/admin/create_task'" style="width:60%; position:relative; white-space:normal; background-color: #C5E1A5; font-size:24px" type="button" value="Create taskDTO" /></td>
      <td style="text-align: center; vertical-align: middle;">
